...
A través de esta memoria se intenta explicar de una manera clara como se ha abordado el problema, desde el diseño hasta la implementación, pasando por el estudio y comprensión de la metaheurística empleada para la búsqueda optima de una solución factible al problema, en este caso mediante el algoritmo Greedy Randomized Adaptive Search Procedure (GRASP) o Procedimiento de Búsqueda Voráz Aleatoria y Adaptativa, la cual ofrece buenas soluciones en un tiempo de computo razonable.

Este problema es una derivación del clásico Maximal Clique Problem (MCP) que consiste en encontrar el clique máximo en un grafo.

El MRCP es un problema con aplicaciones tan actuales como el machine-learning o las redes sociales, ya que una relación directa de un clique es un grupo de personas con intereses afines y por ello se ha intentado implementar un algoritmo que trate los datos de la manera más eficiente posible, con el fin de agilizar el tratamiento de esos datos a posteriori.
\end{abstract}
